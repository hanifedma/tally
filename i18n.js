...
const STRINGS = {
  en: {
    ...
    "filter.clear": "Show every account again",
    ...
    "reset.help": "Erase everything and set this account back to its first day.",
    "reset.confirm": "Start over?",
    "reset.body": "This erases {tx} transactions, {acc} accounts, {cat} categories and {bud} budgets, on every device. The starting categories and accounts come back, and your theme and language are kept. It cannot be undone — export a CSV first if you want to keep any of it.",
    "reset.bodyLocal": "This erases {tx} transactions, {acc} accounts, {cat} categories and {bud} budgets from this device. The starting categories and accounts come back, and your theme and language are kept. It cannot be undone — export a CSV first if you want to keep any of it.",
    "reset.confirmLabel": "Erase and start over",
    "reset.done": "Everything is back to its first day.",
    "reset.failed": "Couldn't finish the reset. Nothing was lost — try again.",
    ...
    "log.emptyAccount.h": "Nothing in {name} this month",
    "log.emptyAccount.p": "No money has gone into or out of {name} yet.",
    ...
    "ins.budgetAllAccounts": "Budgets count every account, not only {name}.",
    ...
    "acc.seeTransactions": "See everything in {name}",
    "acc.new": "New account",
    "acc.name": "Name",
    ...
    "acc.currencyConfirm": "Change this account to {to}?",
    "acc.currencyBody": "Nothing is converted. What is already in it was recorded in {from} and stays as it is, so the balance stops reading {was} and starts reading {now}. Do this only if it was filed under the wrong currency to begin with.",
    "acc.currencyKeep": "Change it anyway",
    ...
    "tx.fee": "Fee",
    "tx.feeHelp": "What the bank kept. It leaves the sending account on top of the amount, and counts as spending.",
    "tx.feeBad": "That is not a fee Tally can read",
    "tx.feeOf": "fee {amount}",
    "tx.fees": "Transfer fees",
  ...
  ko: {
    ...
    "local.erased": "지웠습니다.",
    "reset.title": "처음부터 다시",
    "reset.help": "모든 내용을 지우고 이 계정을 처음 상태로 되돌립니다.",
    "reset.confirm": "처음부터 다시 시작할까요?",
    "reset.body": "모든 기기에서 내역 {tx}건, 계좌 {acc}개, 분류 {cat}개, 예산 {bud}개를 지웁니다. 기본 분류와 계좌는 다시 만들어지고, 테마와 언어는 그대로 둡니다. 되돌릴 수 없으니 남기고 싶다면 먼저 CSV로 내보내세요.",
    "reset.bodyLocal": "이 기기에서 내역 {tx}건, 계좌 {acc}개, 분류 {cat}개, 예산 {bud}개를 지웁니다. 기본 분류와 계좌는 다시 만들어지고, 테마와 언어는 그대로 둡니다. 되돌릴 수 없으니 남기고 싶다면 먼저 CSV로 내보내세요.",
    "reset.confirmLabel": "지우고 처음부터",
    "reset.done": "처음 상태로 되돌렸습니다.",
    "reset.failed": "초기화를 끝내지 못했습니다. 사라진 내용은 없으니 다시 시도해 주세요.",
    ...
    "log.emptyAccount.h": "이번 달 {name} 내역이 없습니다",
    "log.emptyAccount.p": "{name}에 들어오거나 나간 돈이 아직 없습니다.",
    "log.dayTotal": "하루 합계",
    ...
    "ins.budgetAllAccounts": "예산은 {name}뿐 아니라 모든 자산을 합산합니다.",
    ...
    "acc.add": "자산 추가",
    "acc.edit": "자산 편집",
    "acc.seeTransactions": "{name} 내역 보기",
    "acc.new": "새 자산",
    "acc.name": "이름",
    ...
    "acc.currencyConfirm": "이 자산을 {to}로 바꿀까요?",
    "acc.currencyBody": "환산은 하지 않습니다. 이미 들어 있는 내역은 {from}으로 적힌 그대로 남기 때문에, 잔액이 {was}에서 {now}으로 바뀝니다. 처음부터 통화를 잘못 골랐을 때만 사용하세요.",
    "acc.currencyKeep": "그래도 바꾸기",
    ...
    "tx.fee": "수수료",
    "tx.feeHelp": "은행이 가져간 금액입니다. 보내는 금액과 별도로 빠져나가고 지출로 잡힙니다.",
    "tx.feeBad": "읽을 수 없는 수수료입니다",
    "tx.feeOf": "수수료 {amount}",
    "tx.fees": "송금 수수료",
