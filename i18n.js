...
const STRINGS = {
  en: {
    ...
    "acc.currencyBody": "Nothing is converted. Its {n} entries were recorded in {from} and stay as they are, so the balance stops reading {was} and starts reading {now}. Do this only if it was filed under the wrong currency to begin with.",
  ...
  ko: {
    ...
    "acc.currencyBody": "환산은 하지 않습니다. 이미 기록된 {n}건은 {from}으로 적힌 그대로 남기 때문에, 잔액이 {was}에서 {now}으로 바뀝니다. 처음부터 통화를 잘못 골랐을 때만 사용하세요.",
